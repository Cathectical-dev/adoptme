local Config = {
    WindowName = "Money Hub FR (Pornhub)",
...
spawn(function()
    while wait(60) and Settings.PetFarm and Settings.Refresh do
        game:GetService("ReplicatedStorage").API:FindFirstChild("ToolAPI/UnequipAll"):FireServer()    
    end 
end)
...
local Toggle434 = Section1:CreateToggle("Auto Refresh PetFarm", Settings.Refresh, function(State)
